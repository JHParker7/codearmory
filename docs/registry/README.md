...
| `SERVICES` | — | Comma-separated `name=url` pairs to seed on startup (e.g. `blueprints=http://blueprints:8093,forge=http://forge:8083`). Idempotent — updates the URL if the service already exists. |
