...
// privileged: on only for kernel-isolated default backends (kata/proxmox/gvisor),
// where a guest/userspace kernel is the isolation boundary; off for shared-kernel
// backends (docker/kubernetes/unset).
