...
func setupTestDB(t *testing.T) (db *gorm.DB, storageRoot string) {
	...
	if err := gdb.AutoMigrate(&Repo{}, &ShardNode{}, &ReplicaState{}, &MaintenanceLease{},
		&PullRequest{}, &PullReview{}, &PullComment{}, &CommitStatus{},
		&BranchProtection{}, &RepoWebhook{}); err != nil {
