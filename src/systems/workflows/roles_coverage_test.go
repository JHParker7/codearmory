...
func TestCollectWorkflowPermissions_AsyncGrantsPollPermission(t *testing.T) {
	...
	perms := collectWorkflowPermissions([]WorkflowStep{{Step: Step{Action: "forge/run"}}}, nil, nil)
...
func TestCollectWorkflowPermissions_CreateVolumeGrantsDeleteAndPoll(t *testing.T) {
	...
	perms := collectWorkflowPermissions([]WorkflowStep{{Step: Step{Action: "forge/create-volume"}}}, nil, nil)
