...
func TestProvisionWorkflowRole_ErrorResponses(t *testing.T) {
	...
	if rid := provisionWorkflowRole(context.Background(), "wf", "u", "o", steps, nil, nil); rid != "" {
...
func TestProvisionWorkflowRole_NoKey(t *testing.T) {
	...
	if rid := provisionWorkflowRole(context.Background(), "wf", "u", "o", []WorkflowStep{{Step: Step{Action: "forge/run"}}}, nil, nil); rid != "" {
