...
func TestHandleGetState_MissingAuth(t *testing.T) {
	...
	handleGetState(w, r, "user/workspace", "blueprints/states/user/workspace")
...
func TestHandleUpdateState_MissingAuth(t *testing.T) {
	...
	handleUpdateState(w, r, "user/workspace", "blueprints/states/user/workspace")
...
func TestHandleDeleteState_MissingAuth(t *testing.T) {
	...
	handleDeleteState(w, r, "user/workspace", "blueprints/states/user/workspace")
...
func TestHandleLockState_MissingAuth(t *testing.T) {
	...
	handleLockState(w, r, "user/workspace", "blueprints/states/user/workspace")
...
func TestHandleUnlockState_MissingAuth(t *testing.T) {
	...
	handleUnlockState(w, r, "user/workspace", "blueprints/states/user/workspace")
