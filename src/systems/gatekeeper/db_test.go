...
func TestMain(m *testing.M) {
	...
	conn.AutoMigrate(&User{}, &Org{}, &Team{}, &Role{}, &RoleMembership{}, &UserOrgMembership{}, &Session{}, &Permissions{}, &Invite{}, &ServiceAccount{}, &ServicePermissionRequest{}, &AuditLog{}, &PermissionsCheck{}, &Secret{}, &OrgSecretProvider{}, &OAuthClient{}, &OAuthCode{}, &TOTPCredential{}, &MFAPending{}, &SignupAllowlistEntry{}, &SignupPolicy{})
	gormDB = conn
	initMetrics()
